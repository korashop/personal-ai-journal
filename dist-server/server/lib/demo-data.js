...
export const demoEntries = [
    {
        ...
        rawText: 'I keep saying I want to move faster, but I still spend most of my energy trying to avoid visible mistakes. The tradeoff is starting to feel dishonest.',
        source: 'typed',
            ...
            sections: [
                {
                    id: 'main-read',
                    title: 'Main read',
                    content: 'You are not confused about what you want. You want momentum, but you keep structuring your behavior around self-protection instead.',
                },
                {
                    id: 'underneath',
                    title: 'What seems active underneath',
                    content: 'The hidden move is treating caution as sophistication. That lets you postpone embarrassment while still feeling serious.',
                },
            ],
            exploreOptions: [
...
export const demoConversations = [
    {
        ...
        role: 'assistant',
        content: 'You keep framing the bottleneck as incomplete thinking, but the entry reads like you already know the answer and dislike the exposure that comes with acting on it.',
